...
int main(int argc, char** argv)
{
	 ...
	 */ 
	// MPI_Barrier(computeComm); // everyone stop sending data 

	if(streamParams.testFlag)
	{
		printf("compute barrier reached \n"); 
		MPI_Barrier(comm); // if iocompinit is compiled with testing flag, it will sync before finalising. 
